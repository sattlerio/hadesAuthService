...
from hades.exceptions.configurations_exceptions import ImproperlyConfigured
...
# import blueprints
from hades.views import authentication
...
def test():
    ...
    tests = unittest.TestLoader().discover('hades/tests', pattern='*_tests.py')
